...
<body>
    ...
    <header class="p-2 mb-2">
        <div class="container-lg">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <li class="nav-item"><a href="/resources/views/About.html" class="nav-link px-2 link-dark">Acerca de nosotros</a></li>
                <li class="nav-item"><a href="/resources/views/carrito.html" class="nav-link px-2 link-dark">Tu carrito</a></li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdown04">
                        ...
                        <li><a class="dropdown-item" href="https://api.WhatsApp.com/send?phone=3012439584">Chatea con nosotros 👉 +57 3004589584</a></li>
                    </ul>
                </li>
            </ul>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <img class="d-block w-100" src="/public/img/si2.jpg" style="width:100%" alt="First slide">
        </div>
            <div class="carousel-item">
            <img class="d-block w-100" src="/public/img/si4.png" style="width:100%" alt="Second slide">
            </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="/public/img/si3.png" style="width:100%" alt="Third slide">
        </div>
        </div>
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                <div class="col">
                    <div class="card shadow-sm">
                        <img src="/public/img/productos_img/coco.jpg">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                            <a href="/resources/views/Details/viewsCoco.html" type="button" class="btn btn-md btn-outline-primary">Detalles</a>
                            </div>
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        <img src="/public/img/productos_img/almendras.jpg">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                            <a href="/resources/views/Details/viewsAlmendras.html" type="button" class="btn btn-md btn-outline-primary">Detalles</a>
                            </div>
                            <a href="#" type="button" class="btn btn-md btn-outline-success">Agregar</a>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        <img src="/public/img/productos_img/hojuelas.jpg">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                            <a href="/resources/views/Details/viewsHojuelas.html" type="button" class="btn btn-md btn-outline-primary">Detalles</a>
                            </div>
                            <a href="#" type="button" class="btn btn-md btn-outline-success">Agregar</a>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        <img src="/public/img/productos_img/granola.jpg">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                            <a href="/resources/views/Details/viewsGranola.html" type="button" class="btn btn-md btn-outline-primary">Detalles</a>
                            </div>
                            <a href="#" type="button" class="btn btn-md btn-outline-success">Agregar</a>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        <img src="/public/img/productos_img/quinua.jpg">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                            <a href="/resources/views/Details/viewsQuinua.html" type="button" class="btn btn-md btn-outline-primary">Detalles</a>
                            </div>
                            <a href="#" type="button" class="btn btn-md btn-outline-success">Agregar</a>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        <img src="/public/img/productos_img/arandanos.jpg">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                            <a href="/resources/views/Details/viewsArandanos.html" type="button" class="btn btn-md btn-outline-primary">Detalles</a>
                            </div>
                            <a href="#" type="button" class="btn btn-md btn-outline-success">Agregar</a>
                        </div>
                    </div>
