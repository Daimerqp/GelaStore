...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/public/css/stylePago.css">
  ...
  <main>
    ...
    <div class="row g-5">
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form action="/resources/views/pagoTest.html" class="needs-validation" novalidate>
          <div class="row g-3">
            <div class="col-sm-6">
...
<script src="/public/js/pagoVal.js"></script>
  </body>
</html>